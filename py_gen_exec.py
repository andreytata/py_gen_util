...
namespace gx { namespace geom {

class generated : public QObject {
    Q_OBJECT
public:
    virtuaL ~generated(){}
    gx::geom::node* mp_selected = nullptr;
    gx::geom::node* select_node(gx::geon::node*);
public slots:
%%get_gap_public_slots%%
};

}}     // END gx::geom::
#endif // END GX_AUTOGENERATED_FACTORY
"""
...
"""
    ...
    def get_gap_includes(self): return "%%/*get_gap_includes*/%%"
    def get_gap_public_slots(self): return "%%/*get_gap_public_slots*/%%"
